...
****************************************	
P0Settings = $a4			; Bits 0-2 are sprite settings, 
P0Mirrored = $a4			; 3 is reflection, bits 4-5 are missile settings. 
****************************************
P0Height = $a5

*** P1 Settings
P1SpritePointer = $a6		; 16bit
P1ColorPointer = $a8		; 16bit

****************************************		
P1Settings = $aa			; Bits 0-2 are sprite settings, 
P1Mirrored = $aa			; 3 is reflection, bits 4-5 are missile settings. 
****************************************
P1Height = $ab
